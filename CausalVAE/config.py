...
config["data_path"] = config["base_path"] + "data/MICCAI_BraTS_2018_Data_Training" # change to path below if 2020 data shall be used
...
config["CausalVAE_enable"] = True  # Boolean. If True, will enable the VAE module.
